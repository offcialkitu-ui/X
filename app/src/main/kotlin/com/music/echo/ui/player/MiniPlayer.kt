...
private fun NewMiniPlayer(
    ...
    val primaryColor = if (isPurple) Color(0xFF8B5CF6) else if (isDynamicBackground) Color.White else MaterialTheme.colorScheme.primary
    val onPrimaryColor = if (isPurple) Color.White else if (isDynamicBackground) Color.Black else MaterialTheme.colorScheme.onPrimary
    ...
    val onSurfaceColor = if (isPurple) Color.White else if (isDynamicBackground) Color.White else MaterialTheme.colorScheme.onSurface
