...
highlightKey: String? = null) {
    ...
    if (showAudioQualityDialog) {
        EnumDialog(
            ...
            values = listOf(AudioQuality.OPUS, AudioQuality.LOSSLESS, AudioQuality.SAAVN),
            valueText = {
                when (it) {
                    AudioQuality.OPUS -> "Opus"
                    AudioQuality.LOSSLESS -> "Lossless"
                    AudioQuality.SAAVN -> "Premium"
                }
            },
            valueDescription = {
                ""
    ...
    if (showDownloadQualityDialog) {
        EnumDialog(
            ...
            values = listOf(iad1tya.echo.music.constants.DownloadQuality.YOUTUBE, iad1tya.echo.music.constants.DownloadQuality.LOSSLESS, iad1tya.echo.music.constants.DownloadQuality.SAAVN),
            valueText = {
                when (it) {
                    ...
                    iad1tya.echo.music.constants.DownloadQuality.SAAVN -> "Premium"
                }
            }
        )
    }
    ...
    Column(
        ...
        if (showLosslessAudioWarning) {
            DefaultDialog(
                ...
                Text("Lossless is uncompressed music which is higher in size and requires significant server load.\n\nPlease consider donating to support the project!")
            }
        }
        ...
        if (showLosslessDownloadWarning) {
            DefaultDialog(
                ...
                Text("Lossless downloads require significant server load and bandwidth.\n\nPlease consider donating to support the project!")
            }
        }
